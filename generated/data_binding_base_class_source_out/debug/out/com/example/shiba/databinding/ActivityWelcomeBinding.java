...
public final class ActivityWelcomeBinding implements ViewBinding {
  ...
  private ActivityWelcomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button Btnregister,
      @NonNull TextView Txtsignin, @NonNull ImageView mainImg, @NonNull TextView textView2,
  ...
  public static ActivityWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.main_img;
      ImageView mainImg = ViewBindings.findChildViewById(rootView, id);
      if (mainImg == null) {
        break missingId;
      }
      ...
      return new ActivityWelcomeBinding((ConstraintLayout) rootView, Btnregister, Txtsignin,
          mainImg, textView2, textView3);
    }
